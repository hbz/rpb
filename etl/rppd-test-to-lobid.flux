...
// zgrep -a '"type":"api::person.person"' etl/strapi-export-test.tar.gz > etl/output/test-rppd-export.json
// sbt "runMain rpb.ETL etl/rppd-test-to-lobid.flux IN_FILE=test-rppd-export.json RECORD_PATH=data"
