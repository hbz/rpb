...
sbt "runMain rpb.ETL conf/rppd-beacon-to-tsv.flux IN=http://germania-sacra-datenbank.uni-goettingen.de/beacon.txt OUT=conf/maps/beacons/gndId-to-germania-sacra.tsv"
sbt "runMain rpb.ETL conf/rppd-beacon-to-tsv.flux IN=https://www.historische-kommission-muenchen-editionen.de/beacon_adr.txt OUT=conf/maps/beacons/gndId-to-adr.tsv"
...
sbt "runMain rpb.ETL conf/rppd-beacon-to-tsv.flux IN=https://www.tripota.uni-trier.de/beacon_tripota.txt OUT=conf/maps/beacons/gndId-to-tripota.tsv"
...
sbt "runMain rpb.ETL conf/rppd-beacon-to-tsv.flux IN=http://resolver.hebis.de/wikimedia/pndresolver/beacon.txt OUT=conf/maps/beacons/gndId-to-hebis.tsv"
sbt "runMain rpb.ETL conf/rppd-beacon-to-tsv.flux IN=http://www.bib-bvb.de/OpenData/beacon_bvb01.txt OUT=conf/maps/beacons/gndId-to-b3kat.tsv"
...
sbt "runMain rpb.ETL conf/rppd-beacon-to-tsv.flux IN=https://katalog.ub.uni-heidelberg.de/beacon.txt OUT=conf/maps/beacons/gndId-to-heidi.tsv"
