...
sbt --java-home $JAVA_HOME "runMain rpb.ETL etl/rppd-beacon-to-tsv.flux IN=https://www.statistik-bw.de/LABI/Reichstag-Abgeordnetendatenbank.txt OUT=etl/maps/beacons/gndId-to-radb.tsv"
...
sbt --java-home $JAVA_HOME "runMain rpb.ETL etl/rppd-beacon-to-tsv.flux IN=https://www.archinform.net/service/beacon.txt OUT=etl/maps/beacons/gndId-to-archinform.tsv"
...
sbt --java-home $JAVA_HOME "runMain rpb.ETL etl/rppd-beacon-to-tsv.flux IN=https://www.statistik-bw.de/LABI/Badische-Biographien.txt OUT=etl/maps/beacons/gndId-to-babi.tsv"
...
sbt --java-home $JAVA_HOME "runMain rpb.ETL etl/rppd-beacon-to-tsv.flux IN=http://beacon.findbuch.de/downloads/ps_usbk/ps_usbk-pndbeacon.txt OUT=etl/maps/beacons/gndId-to-usbk.tsv"
